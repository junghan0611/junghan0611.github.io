...
### NEXT 13.4. `Narrow the list` of files in Dired {#next-13-dot-4-dot-narrow-the-list-of-files-in-dired}
...
## NEXT 16. For developers or advanced users {#next-16-dot-for-developers-or-advanced-users}
