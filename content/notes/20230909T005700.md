...
lastmod: 2024-09-21T17:39:31+09:00
tags: ["wizardbook"]
categories: ["bib"]
draft: false
---
...
## (해럴드 애빌슨, 제럴드 제이 서스먼, and 줄리 서스먼 2016) {#해럴드-애빌슨-제럴드-제이-서스먼-and-줄리-서스먼-2016}
...
## (해럴드 에이블슨 et al. 2022)  "자바스크립트로 배우는 SICP : 컴퓨터 프로그램의 구조와 해석" {#해럴드-에이블슨-et-al-dot-2022--자바스크립트로-배우는-sicp-컴퓨터-프로그램의-구조와-해석}
